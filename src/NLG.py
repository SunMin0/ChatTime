...
class NaturalLanguageGenerator:
    ...
    def text_preprocessing(self, text):
        ...
        text = re.sub('카페 라떼', '카페라떼', text)
        text = re.sub('쥬스', '주스', text)
        text = re.sub('토마토 주스', '토마토주스', text)
        text = re.sub('딸기 주스', '딸기주스', text)
        text = re.sub('블루베리 주스', '블루베리주스', text)
        text = re.sub('레몬 에이드', '레몬에이드', text)
        text = re.sub('자몽 에이드', '자몽에이드', text)
        ...
        text = re.sub('카라멜 마끼아또', '카라멜마끼아또', text)
        text = re.sub('이요', '', text)
        text = re.sub('잔요', '잔', text)
        text = re.sub('잔', ' 잔', text)
        text = re.sub('잔의', ' 잔', text)
        text = re.sub('  잔', ' 잔', text)
        text = re.sub('개의', ' 잔', text)
